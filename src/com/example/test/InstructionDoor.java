...
public class InstructionDoor extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.instruction_door);
		...
		new Handler().postDelayed(new Runnable(){
			@Override
			public void run(){
				Intent intent = new Intent (InstructionDoor.this,MainActivity.class);			
				startActivity(intent);			
				InstructionDoor.this.finish();
			}
		}, 2300);
    }
